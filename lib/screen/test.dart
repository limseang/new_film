          ...
          body: NestedScrollView(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 10,),
                            Text("Film Library",style: TextStyle(color: Colors.white),),
                            SizedBox(width: 10,),
            ...
            children: [
              ...
              Container(
               ...
               width: Get.width,
                ...
                child: ListView.builder(
                  ...
                  itemCount: articalController.categoryModel?.categories!.length,
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Center(
                                child: Text(articalController.categoryModel?.categories![index].title ?? "",
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 12,
                                  ),
              ...
              Container(
                ...
                child: ListView.builder(
                  scrollDirection: Axis.horizontal,
                  itemCount: articalController.sub_categoryModels?.subCategory!.length,
                  itemBuilder: (context, index) {
                    return GestureDetector(
                        onTap: () {

                        nextScreen(context, articalByScreen(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(left: 8.0, right: 8.0),
                              child: Center(
                                child: Text(articalController.sub_categoryModels?.subCategory![index].title ?? "",
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 12,
                                  ),
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        nextScreen(context, ArticalDetail(
                          articalDetail: articalController.articalsList[index],

                        ));
                      },
                      child: articalController.articalsList[index].featureId == 'normal' ? Container(
                        // height: 280,
                        width: Get.width,
                        child: FeaturedCard(
                         d: articalController.articalsList[index],
                          heroTag: 'avc$index',
                        ),
                      ) : Container(
                        // height: 280,
                            ...
                            children: [
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: NetworkImage(articalController.articalsList[index].thumnail ?? ""),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      articalController.articalsList[index].title ?? "",
                                      style: textStyleMedium.copyWith(fontSize: 16, color: Colors.black54),
                                    ),
                                    SizedBox(height: 12,),
                                    Row(
                                      children: [
                                        Container(
                                          ...
                                          child: Padding(
                                            padding: const EdgeInsets.only(left: 8.0, right: 8.0),
                                            child: Text(
                                              articalController.articalsList[index].categoryId ?? "",
                                              style: textStyleRegular.copyWith(fontSize: 12, color: Colors.black54),
                                            ),
                                          ),
                                        ),
                                        SizedBox(width: 10,),
