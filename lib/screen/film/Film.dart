            ...
            return  NestedScrollView(
              ...
              body: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 20,),
                    Text('Now showing',style: textStyleBlack,)
                    ,SizedBox(height: 20,),
                    Container(
                      height: 450,
                      width: 140,
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: (){},
                            child: controller.filmModelList![index].featureId == 'now showing'
                              ?Stack(
                                children: [
                                  Expanded(
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image: NetworkImage(controller.filmModelList![index].poster!),
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(child: Text("${controller.filmModelList?[index].rateId ?? '0'}")),
